...
import { loginUser, registerUser } from "../../api/authApi.jsx"; // Import the API functions
import useAuth from "../../hooks/useAuth.jsx"; // Import the custom hook
const DoctorLoginModal = ({ isOpen, onClose, redirectTo }) => {
  const { login } = useAuth(); // Access the login function from context
  const [isLoginView, setIsLoginView] = useState(true);
  const [formData, setFormData] = useState({ role: "doctor", email: "", password: "", name: "" });
  ...
  const benefits = [
    {
      ...
      description: "Expand your practice with 24/7 access to patients through video consultations.",
    },
    {
      image: "/path-to-benefits-image2.png",
      description: "Save time with instant electronic prescription tools for seamless patient management.",
    },
    {
      image: "/path-to-benefits-image3.png",
      description: "Collaborate with other specialists and gain access to a broader patient network anytime, anywhere.",
    },
  ];
        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-center border-b px-8 py-6">
              <h2 className="text-xl font-semibold">Benefits as Doctor at DocTime</h2>
              <button
                onClick={onClose}
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-1/2 p-8 bg-gray-50">
                ...
                <p className="text-sm mb-6">
                  Boost your earnings by connecting with more patients and providing care anytime, anywhere.
                </p>
